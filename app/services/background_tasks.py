    ...
    async def process_report_generation(
        ...
        async with SessionLocal() as session:
            ...
            if not company:
                ...
                await report_repo.update_report_status(report_id, StatusEnum.failed)
                return
            ...
            if report_data:
                ...
                await report_repo.update_report_status(report.id, StatusEnum.finish)
                ...
                await report_repo.update_report_status(report.id, StatusEnum.failed)
